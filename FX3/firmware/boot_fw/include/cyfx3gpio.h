/*
 ## Cypress FX3 Boot Firmware Header (cyfx3gpio.h)
 ## ===========================
 ##
 ...
 */
typedef enum CyFx3BootGpioIoMode_t
{
    CY_FX3_GPIO_IO_MODE_NONE = 0,               /**< No internal pull-up or pull-down. Default condition. */
...
/** \brief Set IO mode for the selected GPIO.
    ...
    **Return value**\n
    * CY_FX3_BOOT_SUCCESS            - If the operation is successful.\n
    * CY_FX3_BOOT_ERROR_BAD_ARGUMENT - If the gpioId or ioMode requested is invalid.

    **\see
    *\see CyFx3BootGpioIoMode_t
 */
CyFx3BootErrorCode_t
CyFx3BootGpioSetIoMode (
        uint8_t gpioId,                         /**< GPIO Pin to be updated. */
        CyFx3BootGpioIoMode_t ioMode            /**< Desired pull-up/pull-down mode. */
        );
