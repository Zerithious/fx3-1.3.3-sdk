...
###
### FX3 firmware library - performance profile enabled release configuration
###
...
ASMFLAGS = --cpreproc -g --cpu ARM926EJ-S --apcs /interwork	\
	   ...
	   --pd "CYU3P_PROFILE_EN SETA (1)"			\
	   --pd "CY_USE_ARMCC SETA (1)"

CCFLAGS  = -g --dwarf2 --cpu ARM926EJ-S --apcs /interwork -O3 -Otime	\
	   --strict_warnings --diag_suppress 667			\
	   --split-sections						\
	   -DTX_ENABLE_EVENT_TRACE=1					\
	   -DCYU3P_FX3=1 -DCYU3P_SILICON=1				\
	   -DCYU3P_STORAGE_SDIO_SUPPORT=1 				\
	   -DCYU3P_DISABLE_ERROR_CHECK=1				\
	   -DTX_INCLUDE_USER_DEFINE_FILE=1 -DCYU3P_PROFILE_EN=1		\
	   -DCY_USE_ARMCC=1						\
...
LDFLAGS	= -debug --elf --remove --datacompressor off		\
	  --no_strict_wchar_size --diag_suppress L6436W		\
	  --scatter $(CYU3ROOT)/build/fx3.scat			\
...
CCFLAGS  = -g -mcpu=arm926ej-s -mthumb-interwork -O1		\
