...
/** \mainpage EZ-USB FX3 Api Reference Guide
    ...
    **Description**\n
    ...
    If the memory leak detection is enabled, the allocator adds a 20 byte header and a 4 byte
    ...
    The MemBlockInfo structure defined in cyu3os.h defines the format of the 20 byte header
