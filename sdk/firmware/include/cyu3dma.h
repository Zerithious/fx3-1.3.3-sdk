...
/** \brief DMA channel callback function type.
    ...
    **Description**\n
    ...
    In the case of AUTO_SIGNAL channels, the input parameter points to the latest produced
    buffer. If the callback handling is delayed, the producer socket can potentially overwrite
    this buffer.
