...
/** \brief Erase blocks on the storage card.
    ...
    **Description**\n
    This function is used to erase the specified number of erase units on an SD card. This operation
    is currently supported only for SD cards, and not for MMC/eMMC devices.
