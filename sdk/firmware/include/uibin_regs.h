/*
 ## Cypress FX3 Core Library Header (uibin_regs.h)
 ## ===========================
 ##
...
#ifndef _INCLUDED_UIBIN_REGS_H_
#define _INCLUDED_UIBIN_REGS_H_

#include <cyu3types.h>

#define UIBIN_BASE_ADDR                          (0xe0047f00)

typedef struct
{
    uvint32_t id;                                 /* 0xe0047f00 */
    uvint32_t power;                              /* 0xe0047f04 */
    uvint32_t rsrvd0[62];
    struct
    {
        uvint32_t dscr;                           /* 0xe0048000 */
        uvint32_t size;                           /* 0xe0048004 */
        uvint32_t count;                          /* 0xe0048008 */
        uvint32_t status;                         /* 0xe004800c */
        uvint32_t intr;                           /* 0xe0048010 */
        uvint32_t intr_mask;                      /* 0xe0048014 */
        uvint32_t rsrvd1[2];
        uvint32_t dscr_buffer;                    /* 0xe0048020 */
        uvint32_t dscr_sync;                      /* 0xe0048024 */
        uvint32_t dscr_chain;                     /* 0xe0048028 */
        uvint32_t dscr_size;                      /* 0xe004802c */
        uvint32_t rsrvd2[19];
        uvint32_t event;                          /* 0xe004807c */
    } sck[16];
    uvint32_t rsrvd3[7616];
    uvint32_t sck_intr0;                          /* 0xe004ff00 */
    uvint32_t sck_intr1;                          /* 0xe004ff04 */
    uvint32_t sck_intr2;                          /* 0xe004ff08 */
    uvint32_t sck_intr3;                          /* 0xe004ff0c */
    uvint32_t sck_intr4;                          /* 0xe004ff10 */
    uvint32_t sck_intr5;                          /* 0xe004ff14 */
    uvint32_t sck_intr6;                          /* 0xe004ff18 */
    uvint32_t sck_intr7;                          /* 0xe004ff1c */
    uvint32_t rsrvd4[56];
} UIBIN_REGS_T, *PUIBIN_REGS_T;

#define UIBIN        ((PUIBIN_REGS_T) UIBIN_BASE_ADDR)


/*
   Block Identification and Version Number
 */
#define CY_U3P_UIBIN_ID_ADDRESS                             (0xe0047f00)
#define CY_U3P_UIBIN_ID                                     (*(uvint32_t *)(0xe0047f00))
#define CY_U3P_UIBIN_ID_DEFAULT                             (0x00010004)

/*
   A unique number identifying the IP in the memory space.
 */
#define CY_U3P_UIBIN_BLOCK_ID_MASK                          (0x0000ffff) /* <0:15> R:R:0x0004:N/A */
#define CY_U3P_UIBIN_BLOCK_ID_POS                           (0)


/*
   Version number for the IP.
 */
#define CY_U3P_UIBIN_BLOCK_VERSION_MASK                     (0xffff0000) /* <16:31> R:R:0x0001:N/A */
#define CY_U3P_UIBIN_BLOCK_VERSION_POS                      (16)
 ...
 */
#define CY_U3P_UIBIN_POWER_ADDRESS                          (0xe0047f04)
#define CY_U3P_UIBIN_POWER                                  (*(uvint32_t *)(0xe0047f04))
#define CY_U3P_UIBIN_POWER_DEFAULT                          (0x00000000)
...
/*
   ...
   This bit is a copy of UIB_POWER.active.  Preferably use UIB_POWER register
   instead.
 */
#define CY_U3P_UIBIN_ACTIVE                                 (1u << 0) /* <0:0> W:R:0:No */
...
/*
   ...
   This bit is non-functional for UIBIN and will not reset anything.  Use
   UIB_POWER register instead.
 */
#define CY_U3P_UIBIN_RESETN                                 (1u << 31) /* <31:31> R:RW:0:No */
 ...
 */
#define CY_U3P_UIBIN_SCK_DSCR_ADDRESS(n)                    (0xe0048000 + ((n) * (0x0080)))
#define CY_U3P_UIBIN_SCK_DSCR(n)                            (*(uvint32_t *)(0xe0048000 + ((n) * 0x0080)))
#define CY_U3P_UIBIN_SCK_DSCR_DEFAULT                       (0x00000000)
 ...
 */
#define CY_U3P_UIBIN_DSCR_NUMBER_MASK                       (0x0000ffff) /* <0:15> RW:RW:X:N/A */
#define CY_U3P_UIBIN_DSCR_NUMBER_POS                        (0)
 ...
 */
#define CY_U3P_UIBIN_DSCR_COUNT_MASK                        (0x00ff0000) /* <16:23> RW:RW:X:N/A */
#define CY_U3P_UIBIN_DSCR_COUNT_POS                         (16)
 ...
 */
#define CY_U3P_UIBIN_DSCR_LOW_MASK                          (0xff000000) /* <24:31> R:RW:X:N/A */
#define CY_U3P_UIBIN_DSCR_LOW_POS                           (24)
 ...
 */
#define CY_U3P_UIBIN_SCK_SIZE_ADDRESS(n)                    (0xe0048004 + ((n) * (0x0080)))
#define CY_U3P_UIBIN_SCK_SIZE(n)                            (*(uvint32_t *)(0xe0048004 + ((n) * 0x0080)))
#define CY_U3P_UIBIN_SCK_SIZE_DEFAULT                       (0x00000000)
 ...
 */
#define CY_U3P_UIBIN_TRANS_SIZE_MASK                        (0xffffffff) /* <0:31> R:RW:X:N/A */
#define CY_U3P_UIBIN_TRANS_SIZE_POS                         (0)
 ...
 */
#define CY_U3P_UIBIN_SCK_COUNT_ADDRESS(n)                   (0xe0048008 + ((n) * (0x0080)))
#define CY_U3P_UIBIN_SCK_COUNT(n)                           (*(uvint32_t *)(0xe0048008 + ((n) * 0x0080)))
#define CY_U3P_UIBIN_SCK_COUNT_DEFAULT                      (0x00000000)
 ...
 */
#define CY_U3P_UIBIN_TRANS_COUNT_MASK                       (0xffffffff) /* <0:31> RW:RW:X:N/A */
#define CY_U3P_UIBIN_TRANS_COUNT_POS                        (0)
 ...
 */
#define CY_U3P_UIBIN_SCK_STATUS_ADDRESS(n)                  (0xe004800c + ((n) * (0x0080)))
#define CY_U3P_UIBIN_SCK_STATUS(n)                          (*(uvint32_t *)(0xe004800c + ((n) * 0x0080)))
#define CY_U3P_UIBIN_SCK_STATUS_DEFAULT                     (0x04e00000)
...
/*
   ...
   (sck_more_buf_avl).
 */
#define CY_U3P_UIBIN_AVL_COUNT_MASK                         (0x0000001f) /* <0:4> RW:RW:0:N/A */
#define CY_U3P_UIBIN_AVL_COUNT_POS                          (0)
 ...
 */
#define CY_U3P_UIBIN_AVL_MIN_MASK                           (0x000003e0) /* <5:9> R:RW:0:N/A */
#define CY_U3P_UIBIN_AVL_MIN_POS                            (5)
...
/*
   ...
   described above.
 */
#define CY_U3P_UIBIN_AVL_ENABLE                             (1u << 10) /* <10:10> R:RW:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_STATE_MASK                             (0x00038000) /* <15:17> RW:R:0:N/A */
#define CY_U3P_UIBIN_STATE_POS                              (15)
 ...
 */
#define CY_U3P_UIBIN_STATE_CHECK1                           (4)
/*
   Socket is suspended
 */
#define CY_U3P_UIBIN_STATE_SUSPENDED                        (5)
/*
   Check states. An active socket gets here based on the core’s EOP request
   to check the Transfer size and determine whether the buffer should be
   wrapped up. Depending on result, socket will either go back to Active
   state or move to the Event state.
 */
#define CY_U3P_UIBIN_STATE_CHECK2                           (6)
/*
   Waiting for confirmation that event was sent.
 */
#define CY_U3P_UIBIN_STATE_WAITING                          (7)

/*
   Indicates the socket received a ZLP
 */
#define CY_U3P_UIBIN_ZLP_RCVD                               (1u << 18) /* <18:18> RW:R:0:N/A */
...
/*
   ...
   again cleared.
 */
#define CY_U3P_UIBIN_SUSPENDED                              (1u << 19) /* <19:19> RW:R:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_ENABLED                                (1u << 20) /* <20:20> RW:R:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_TRUNCATE                               (1u << 21) /* <21:21> R:RW:1:N/A */
 ...
 */
#define CY_U3P_UIBIN_EN_PROD_EVENTS                         (1u << 22) /* <22:22> R:RW:1:N/A */
...
/*
   ...
   not be copied back into memory when completed.
 */
#define CY_U3P_UIBIN_EN_CONS_EVENTS                         (1u << 23) /* <23:23> R:RW:1:N/A */
 ...
 */
#define CY_U3P_UIBIN_SUSP_PARTIAL                           (1u << 24) /* <24:24> R:RW:0:N/A */
...
/*
   ...
   and egress sockets.
 */
#define CY_U3P_UIBIN_SUSP_LAST                              (1u << 25) /* <25:25> R:RW:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_SUSP_TRANS                             (1u << 26) /* <26:26> R:RW:1:N/A */
...
/*
   ...
   and egress sockets.
 */
#define CY_U3P_UIBIN_SUSP_EOP                               (1u << 27) /* <27:27> R:RW:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_WRAPUP                                 (1u << 28) /* <28:28> RW0C:RW1S:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_UNIT                                   (1u << 29) /* <29:29> R:RW:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_GO_SUSPEND                             (1u << 30) /* <30:30> R:RW:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_GO_ENABLE                              (1u << 31) /* <31:31> R:RW:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_SCK_INTR_ADDRESS(n)                    (0xe0048010 + ((n) * (0x0080)))
#define CY_U3P_UIBIN_SCK_INTR(n)                            (*(uvint32_t *)(0xe0048010 + ((n) * 0x0080)))
#define CY_U3P_UIBIN_SCK_INTR_DEFAULT                       (0x00000000)

/*
   Indicates that a produce event has been received or transmitted since
   last cleared.
 */
#define CY_U3P_UIBIN_PRODUCE_EVENT                          (1u << 0) /* <0:0> W1S:RW1C:0:N/A */
...
/*
   ...
   last cleared.
 */
#define CY_U3P_UIBIN_CONSUME_EVENT                          (1u << 1) /* <1:1> W1S:RW1C:0:N/A */
...
/*
   ...
   cleared by s/w
 */
#define CY_U3P_UIBIN_DSCR_IS_LOW                            (1u << 2) /* <2:2> W1S:RW1C:0:N/A */
...
/*
   ...
   loaded.
 */
#define CY_U3P_UIBIN_DSCR_NOT_AVL                           (1u << 3) /* <3:3> W1S:RW1C:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_STALL                                  (1u << 4) /* <4:4> W1S:RW1C:0:N/A */
...
/*
   ...
   Note that the socket resumes only when SCK_INTR[9:5]=0 and GO_SUSPEND=0.
 */
#define CY_U3P_UIBIN_SUSPEND                                (1u << 5) /* <5:5> W1S:RW1C:0:N/A */
...
/*
   ...
   Note that the socket resumes only when SCK_INTR[9:5]=0 and GO_SUSPEND=0.
 */
#define CY_U3P_UIBIN_ERROR                                  (1u << 6) /* <6:6> W1S:RW1C:0:N/A */
...
/*
   ...
   Note that the socket resumes only when SCK_INTR[9:5]=0 and GO_SUSPEND=0.
 */
#define CY_U3P_UIBIN_TRANS_DONE                             (1u << 7) /* <7:7> W1S:RW1C:0:N/A */
...
/*
   ...
   GO_SUSPEND=0.
 */
#define CY_U3P_UIBIN_PARTIAL_BUF                            (1u << 8) /* <8:8> W1S:RW1C:0:N/A */
...
/*
   Indicates that the socket was suspended because of SUSP_LAST condition.
    Note that the socket resumes only when SCK_INTR[9:5]=0 and GO_SUSPEND=0.
 */
#define CY_U3P_UIBIN_LAST_BUF                               (1u << 9) /* <9:9> W1S:RW1C:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_SCK_INTR_MASK_ADDRESS(n)               (0xe0048014 + ((n) * (0x0080)))
#define CY_U3P_UIBIN_SCK_INTR_MASK(n)                       (*(uvint32_t *)(0xe0048014 + ((n) * 0x0080)))
#define CY_U3P_UIBIN_SCK_INTR_MASK_DEFAULT                  (0x00000000)

/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_PRODUCE_EVENT                          (1u << 0) /* <0:0> R:RW:0:N/A */


/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_CONSUME_EVENT                          (1u << 1) /* <1:1> R:RW:0:N/A */


/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_DSCR_IS_LOW                            (1u << 2) /* <2:2> R:RW:0:N/A */


/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_DSCR_NOT_AVL                           (1u << 3) /* <3:3> R:RW:0:N/A */


/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_STALL                                  (1u << 4) /* <4:4> R:RW:0:N/A */


/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_SUSPEND                                (1u << 5) /* <5:5> R:RW:0:N/A */


/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_ERROR                                  (1u << 6) /* <6:6> R:RW:0:N/A */


/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_TRANS_DONE                             (1u << 7) /* <7:7> R:RW:0:N/A */


/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_PARTIAL_BUF                            (1u << 8) /* <8:8> R:RW:0:N/A */


/*
   1: Report interrupt to CPU
 */
#define CY_U3P_UIBIN_LAST_BUF                               (1u << 9) /* <9:9> R:RW:0:N/A */
 ...
 */
#define CY_U3P_UIBIN_DSCR_BUFFER_ADDRESS(n)                 (0xe0048020 + ((n) * (0x0080)))
#define CY_U3P_UIBIN_DSCR_BUFFER(n)                         (*(uvint32_t *)(0xe0048020 + ((n) * 0x0080)))
#define CY_U3P_UIBIN_DSCR_BUFFER_DEFAULT                    (0x00000000)
 ...
 */
#define CY_U3P_UIBIN_BUFFER_ADDR_MASK                       (0xffffffff) /* <0:31> RW:RW:X:N/A */
#define CY_U3P_UIBIN_BUFFER_ADDR_POS                        (0)
 ...
 */
#define CY_U3P_UIBIN_DSCR_SYNC_ADDRESS(n)                   (0xe0048024 + ((n) * (0x0080)))
#define CY_U3P_UIBIN_DSCR_SYNC(n)                           (*(uvint32_t *)(0xe0048024 + ((n) * 0x0080)))
#define CY_U3P_UIBIN_DSCR_SYNC_DEFAULT                      (0x00000000)
 ...
 */
#define CY_U3P_UIBIN_CONS_SCK_MASK                          (0x000000ff) /* <0:7> RW:RW:X:N/A */
#define CY_U3P_UIBIN_CONS_SCK_POS                           (0)
 ...
 */
#define CY_U3P_UIBIN_CONS_IP_MASK                           (0x00003f00) /* <8:13> RW:RW:X:N/A */
#define CY_U3P_UIBIN_CONS_IP_POS                            (8)
...
/*
   ...
   occupied bit.
 */
#define CY_U3P_UIBIN_EN_CONS_EVENT                          (1u << 14) /* <14:14> RW:RW:X:N/A */
 ...
 */
#define CY_U3P_UIBIN_EN_CONS_INT                            (1u << 15) /* <15:15> RW:RW:X:N/A */
 ...
 */
#define CY_U3P_UIBIN_PROD_SCK_MASK                          (0x00ff0000) /* <16:23> RW:RW:X:N/A */
#define CY_U3P_UIBIN_PROD_SCK_POS                           (16)
...
/*
   ...
   to observe this condition.
 */
#define CY_U3P_UIBIN_PROD_IP_MASK                           (0x3f000000) /* <24:29> RW:RW:X:N/A */
#define CY_U3P_UIBIN_PROD_IP_POS                            (24)
 ...
 */
#define CY_U3P_UIBIN_EN_PROD_EVENT                          (1u << 30) /* <30:30> RW:RW:X:N/A */
...
/*
   ...
   interrupt to the CPU like SCK_STATUS.int_mask does.
 */
#define CY_U3P_UIBIN_EN_PROD_INT                            (1u << 31) /* <31:31> RW:RW:X:N/A */
 ...
 */
#define CY_U3P_UIBIN_DSCR_CHAIN_ADDRESS(n)                  (0xe0048028 + ((n) * (0x0080)))
#define CY_U3P_UIBIN_DSCR_CHAIN(n)                          (*(uvint32_t *)(0xe0048028 + ((n) * 0x0080)))
#define CY_U3P_UIBIN_DSCR_CHAIN_DEFAULT                     (0x00000000)

/*
   Descriptor number of the next task for consumer. A value of 0xFFFF signals
   end of this list.
 */
#define CY_U3P_UIBIN_RD_NEXT_DSCR_MASK                      (0x0000ffff) /* <0:15> RW:RW:X:N/A */
#define CY_U3P_UIBIN_RD_NEXT_DSCR_POS                       (0)
 ...
 */
#define CY_U3P_UIBIN_WR_NEXT_DSCR_MASK                      (0xffff0000) /* <16:31> RW:RW:X:N/A */
#define CY_U3P_UIBIN_WR_NEXT_DSCR_POS                       (16)
 ...
 */
#define CY_U3P_UIBIN_DSCR_SIZE_ADDRESS(n)                   (0xe004802c + ((n) * (0x0080)))
#define CY_U3P_UIBIN_DSCR_SIZE(n)                           (*(uvint32_t *)(0xe004802c + ((n) * 0x0080)))
#define CY_U3P_UIBIN_DSCR_SIZE_DEFAULT                      (0x00000000)
 ...
 */
#define CY_U3P_UIBIN_MARKER                                 (1u << 0) /* <0:0> RW:RW:X:N/A */
 ...
 */
#define CY_U3P_UIBIN_EOP                                    (1u << 1) /* <1:1> RW:RW:X:N/A */


/*
   Indicates the buffer data is valid (0) or in error (1).
 */
#define CY_U3P_UIBIN_BUFFER_ERROR                           (1u << 2) /* <2:2> RW:RW:X:N/A */
 ...
 */
#define CY_U3P_UIBIN_BUFFER_OCCUPIED                        (1u << 3) /* <3:3> RW:RW:X:N/A */


/*
   The size of the buffer in multiples of 16 bytes
 */
#define CY_U3P_UIBIN_BUFFER_SIZE_MASK                       (0x0000fff0) /* <4:15> RW:RW:X:N/A */
#define CY_U3P_UIBIN_BUFFER_SIZE_POS                        (4)
 ...
 */
#define CY_U3P_UIBIN_BYTE_COUNT_MASK                        (0xffff0000) /* <16:31> RW:RW:X:N/A */
#define CY_U3P_UIBIN_BYTE_COUNT_POS                         (16)
 ...
 */
#define CY_U3P_UIBIN_EVENT_ADDRESS(n)                       (0xe004807c + ((n) * (0x0080)))
#define CY_U3P_UIBIN_EVENT(n)                               (*(uvint32_t *)(0xe004807c + ((n) * 0x0080)))
#define CY_U3P_UIBIN_EVENT_DEFAULT                          (0x00000000)
...
/*
   Socket Interrupt Request Register
 */
#define CY_U3P_UIBIN_SCK_INTR0_ADDRESS                      (0xe004ff00)
#define CY_U3P_UIBIN_SCK_INTR0                              (*(uvint32_t *)(0xe004ff00))
#define CY_U3P_UIBIN_SCK_INTR0_DEFAULT                      (0x00000000)
 ...
 */
#define CY_U3P_UIBIN_SCKINTR_L_MASK                         (0xffffffff) /* <0:31> W:R:0:N/A */
#define CY_U3P_UIBIN_SCKINTR_L_POS                          (0)
...
/*
   Socket Interrupt Request Register
 */
#define CY_U3P_UIBIN_SCK_INTR1_ADDRESS                      (0xe004ff04)
#define CY_U3P_UIBIN_SCK_INTR1                              (*(uvint32_t *)(0xe004ff04))
#define CY_U3P_UIBIN_SCK_INTR1_DEFAULT                      (0x00000000)
...
/*
   ...
   256 is just the maximum width.  All other bits always return 0.
 */
#define CY_U3P_UIBIN_SCKINTR_H_L_MASK                       (0xffffffff) /* <0:31> W:R:0:N/A */
#define CY_U3P_UIBIN_SCKINTR_H_L_POS                        (0)
...
/*
   Socket Interrupt Request Register
 */
#define CY_U3P_UIBIN_SCK_INTR2_ADDRESS                      (0xe004ff08)
#define CY_U3P_UIBIN_SCK_INTR2                              (*(uvint32_t *)(0xe004ff08))
#define CY_U3P_UIBIN_SCK_INTR2_DEFAULT                      (0x00000000)
...
/*
   Socket Interrupt Request Register
 */
#define CY_U3P_UIBIN_SCK_INTR3_ADDRESS                      (0xe004ff0c)
#define CY_U3P_UIBIN_SCK_INTR3                              (*(uvint32_t *)(0xe004ff0c))
#define CY_U3P_UIBIN_SCK_INTR3_DEFAULT                      (0x00000000)
...
/*
   Socket Interrupt Request Register
 */
#define CY_U3P_UIBIN_SCK_INTR4_ADDRESS                      (0xe004ff10)
#define CY_U3P_UIBIN_SCK_INTR4                              (*(uvint32_t *)(0xe004ff10))
#define CY_U3P_UIBIN_SCK_INTR4_DEFAULT                      (0x00000000)
...
/*
   Socket Interrupt Request Register
 */
#define CY_U3P_UIBIN_SCK_INTR5_ADDRESS                      (0xe004ff14)
#define CY_U3P_UIBIN_SCK_INTR5                              (*(uvint32_t *)(0xe004ff14))
#define CY_U3P_UIBIN_SCK_INTR5_DEFAULT                      (0x00000000)
...
/*
   Socket Interrupt Request Register
 */
#define CY_U3P_UIBIN_SCK_INTR6_ADDRESS                      (0xe004ff18)
#define CY_U3P_UIBIN_SCK_INTR6                              (*(uvint32_t *)(0xe004ff18))
#define CY_U3P_UIBIN_SCK_INTR6_DEFAULT                      (0x00000000)
...
/*
   Socket Interrupt Request Register
 */
#define CY_U3P_UIBIN_SCK_INTR7_ADDRESS                      (0xe004ff1c)
#define CY_U3P_UIBIN_SCK_INTR7                              (*(uvint32_t *)(0xe004ff1c))
#define CY_U3P_UIBIN_SCK_INTR7_DEFAULT                      (0x00000000)
...
/*
   ...
   256 is just the maximum width.  All other bits always return 0.
 */
#define CY_U3P_UIBIN_SCKINTR_H_MASK                         (0xffffffff) /* <0:31> W:R:0:N/A */
#define CY_U3P_UIBIN_SCKINTR_H_POS                          (0)



#endif /* _INCLUDED_UIBIN_REGS_H_ */
