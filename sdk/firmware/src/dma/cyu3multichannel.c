/*
 ## Cypress FX3 DMA Driver Source (cyu3multichannel.c)
 ## ===========================
 ##
        ...
        uint32_t waitOption)
{
    ...
    if ((handle->startSig != CY_U3P_DMA_MULTICHN_START_SIG) || (handle->endSig != CY_U3P_DMA_CHANNEL_END_SIG))
    {
        ...
        CyU3PDmaMultiChannelConfig_t *config)
{
    ...
    if (status == CY_U3P_SUCCESS)
    {
        ...
        /* Store the channel handle signatures. */
        handle->startSig = CY_U3P_DMA_MULTICHN_START_SIG;
