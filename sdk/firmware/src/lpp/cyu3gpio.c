/*
 ## Cypress FX3 Serial Peripheral Driver Source (cyu3gpio.c)
 ## ===========================
 ##
...
#define CY_U3P_GPIO_COUNT       (61)            /* Number of GPIOs on the device. */
...
{    
    ...
    {
        /* Run through all GPIOs and clear any pending interrupts and interrupt enables. */
        for (i = 0; i < CY_U3P_GPIO_COUNT; i++)
        {
            GPIO->lpp_gpio_simple[i] = (GPIO->lpp_gpio_simple[i] & ~CY_U3P_LPP_GPIO_INTRMODE_MASK) |
