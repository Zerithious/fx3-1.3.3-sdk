/*
 ## Cypress FX3 Serial Peripheral Driver Source (cyu3i2c.c)
 ## ===========================
 ##
...
#define CY_U3P_I2C_TIMEOUT              (0xFFFFF)               /* Default response read timeout. */
...
static CyBool_t         glIsI2cActive     = CyFalse;            /* Whether the I2C block is powered on. */
...
static uint32_t         glI2cReadTimeout  = CY_U3P_I2C_TIMEOUT; /* Timeout for I2C read operations. */
static uint32_t         glI2cWriteTimeout = CY_U3P_I2C_TIMEOUT; /* Timeout for I2C write operations. */
static uint32_t         glI2cFlushTimeout = CY_U3P_I2C_TIMEOUT; /* Timeout for I2C error recovery / flush operations. */
              ...
              void)
{
    ...
    * the I2C power up */
    ...
    glI2cReadTimeout  = CY_U3P_I2C_TIMEOUT;
    glI2cWriteTimeout = CY_U3P_I2C_TIMEOUT;
    glI2cFlushTimeout = CY_U3P_I2C_TIMEOUT;
...
CyU3PI2cErrorRecovery (CyBool_t isClearFifo)
{
    ...
    if (isClearFifo)
    {
        ...
        /* Disable the bits. */
        I2C->lpp_i2c_config &= ~(CY_U3P_LPP_I2C_TX_CLEAR | CY_U3P_LPP_I2C_RX_CLEAR);
        CyU3PBusyWait (1);
    }
...
CyU3PI2cSetTimeout (
        ...
        uint32_t flushLoopCnt)
{
    if (!glIsI2cActive)
        return CY_U3P_ERROR_NOT_STARTED;

    glI2cReadTimeout  = readLoopCnt;
    glI2cWriteTimeout = writeLoopCnt;
    glI2cFlushTimeout = flushLoopCnt;
    return CY_U3P_SUCCESS;
}
