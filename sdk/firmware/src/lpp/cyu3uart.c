/*
 ## Cypress FX3 Serial Peripheral Driver Source (cyu3uart.c)
 ## ===========================
 ##
                            ...
                            void)
{
    ...
    {
        glUartIntrCb (CY_U3P_UART_EVENT_RX_DATA, (CyU3PUartError_t)0);
    }
        ...
        CyU3PReturnStatus_t *status)
{
    ...
    for (i = 0; i < count; i++)
    {
        ...
        while (((UART->lpp_uart_intr & CY_U3P_LPP_UART_TX_DONE) == 0) && (timeout != 0))
        {
            timeout--;
        }
