/*
 ## Cypress FX3 USB Driver Source (cyu3usbotg.c)
 ## ===========================
 ##
...
CyU3POtgIssueSrp (void)
{
    ...
    /* TODO: This is a hack as there is no way to send a pulse on the VBUS.
     ...
     * This has to be tested against a third party device to make sure that
     * it works. */
